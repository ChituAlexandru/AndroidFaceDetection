...
public class VideoFaceDetectionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inter = new InterClass();
        inter.setActivity(this);
        inter.setmGraphicOverlay(mGraphicOverlay);
    ...
    private void createCameraSource() {
        ...
        mCameraSource = new CameraSource.Builder(context, detector)
                .setRequestedPreviewSize(1632, 1224)
    ...
    private class GraphicFaceTrackerFactory implements MultiProcessor.Factory<Face> {
        ...
        public Tracker<Face> create(Face face) {
            return new GraphicFaceTracker(inter);
        }
    }
}
